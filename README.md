...
### Manual
Download `main.js`, `manifest.json`, and `styles.css` from the [latest release](https://github.com/jsjixu/obsidian-inklaw-sync/releases/latest) into `<vault>/.obsidian/plugins/inklaw-sync/`, then enable it.
